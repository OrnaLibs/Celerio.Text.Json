...
public class Arguments
{
    ...
    {
        var type = _argumentTypes.FirstOrDefault(t => t.IsRepresents(parameter, endpoint));
        return type ?? throw new Exception($"Cannot find representing argument type: {parameter.Name}");
    }
}