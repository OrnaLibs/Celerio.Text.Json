...
{
    public IHttpProvider HttpProvider { get; set; } = new DefaultHttpProvider();
    
    public IAuthentication Authentication { get; set; } = new Authentication<string>(DateTime.Now.ToString("O"));
    ...
    #region Modules
        ...
        private readonly List<ModuleBase> _modules = [new AuthenticatedCheck(), new Caching()];
