...
public class HttpResponse
{
    ...
    public static HttpResponse BadRequest(string reason, int code = 0) => new(400, "Bad Request", JsonSerializer.Serialize(new { code, reason }, 
    ...
    public static HttpResponse NotFound(string reason, int code = 0) => new (404, "Not Found", JsonSerializer.Serialize(new {code, reason}));
